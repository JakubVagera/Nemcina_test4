...
public class HelloController implements Initializable {
    ...
    public void switchtoScene2(ActionEvent event) throws IOException {
        ...
        if(starter1 == 1){
            ...
            if(ott > skupina.get(index2).count){
                max = ott;
                tt = 1;
            }else{
                max = ott;
            ...
            ma.setVisible(false);
            ma.setText("Po. s. s podskupinami: ");
            ma.setText("Počet slov v skupině: ");
            ma1.setText("Po. s. s podskupinami: ");
            if (move < max) {
                ...
                if (move == 0) {
                    ...
                    if(tt == 0) {
                        ...
                        Collections.sort(wordseries, new GroupComparator());
                            ...
                            for(int g = 0; g < wordseries.size(); g++ ){
                            if (wordseries.get(g).group <= group_number) {
                                xxx = g;
                                zzz = xxx;


                                if(g+2 > wordseries.size()-1 && wordseries.get(g).group < group_number){
                        ...
                        for (;;) {
                            ...
                            if (xxx - zzz == 0) {
                                word.add(wordseries.get(xxx - zzz));
                                yyy++;
                                zzz = 0;
                            }
                            if (yyy == max) {
                ...
                for (int i = 0; i < grouppick.getItems().size(); i++) {
                    for (int t = 0; t < skupina.size(); t++) {
                        if (skupina.get(t).number == ww) {
                            ma.setText(String.valueOf("Počet slov v skupině: "+skupina.get(t).amount));
                            maximum.setText(String.valueOf(skupina.get(t).amount));
                            ma1.setText(String.valueOf("Po. s. s podskupinami: " + skupina.get(t).count));
                        }
                    }
                }
            }
